...
contract InteractionsTest is Test {
    ...
    function testUserSubscriptionsFlow() public {
        vm.prank(user1);
        bytes32 sub1 = vault.createSubscription(
            merchant1,
            address(usdc),
            100 ether,
            30 days
        ...
        vm.prank(user2);
        bytes32 sub2 = vault.createSubscription(
            merchant2,
            address(usdc),
            50 ether,
            15 days
        ...
        (, , , uint256 amount1, , , , bool active1) = vault.getSubscription(
            sub1
        );
        (, , , uint256 amount2, , , , bool active2) = vault.getSubscription(
            sub2
        );
